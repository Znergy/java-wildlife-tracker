...
public class AnimalTest {
  ...
  public void animal_instantiatesCorrectly_false() {
    Animal testAnimal = new Animal("Deer", "brown", "imageURL");
  ...
  public void equals_returnsTrueIfNameIsTheSame_false() {
    Animal firstAnimal = new Animal("Deer", "brown", "imageURL");
    Animal anotherAnimal = new Animal("Deer", "brown", "imageURL");
  ...
  public void all_returnsAllInstancesOfAnimal_false() {
    Animal firstAnimal = new Animal("Deer", "brown", "imageURL");
    firstAnimal.save();
    Animal secondAnimal = new Animal("Black Bear", "brown", "imageURL");
    secondAnimal.save();
